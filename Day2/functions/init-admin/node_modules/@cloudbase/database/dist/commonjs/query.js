...
var websocket_client_1 = require("./realtime/websocket-client");
...
var Query = (function () {
    function Query(db, coll, fieldFilters, fieldOrders, queryOptions) {
        ...
        this.watch = function (options) {
            ...
            return index_1.Db.ws.watch(__assign(__assign({}, options), { envId: _this._db.config.env, collectionName: _this._coll, query: JSON.stringify(_this._fieldFilters), limit: _this._queryOptions.limit, orderBy: _this._fieldOrders
